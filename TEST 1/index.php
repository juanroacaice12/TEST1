...
$ipZip = isset($ipZip) ? $ipZip : ''; // Esto define la variable $ipZip si no está definida previamente
$ringbaScriptPrimary = isset($ringbaScriptPrimary) ? $ringbaScriptPrimary : ''; // Lo mismo para las otras variables
$mbOfferSite = isset($mbOfferSite) ? $mbOfferSite : '';
...
<body>
    ...
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
        ...
        <p class="my-3 md:text-xl" style="text-align: left;">
            Most seniors are going to miss the chance to claim their card because the time to register is ending soon. Ensure you're eligible before time runs out by answering 2 questions below.
        </p>
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1  gap-6">
                    ...
                    <button id="btn-under-64" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-while font-bold rounded-2x1 w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center"> 
                        64 under 
                    </button>
    ...
    <div id="display4" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl container ">
        <div class="p-6 border-t-2 border-blue-500 mt-4 bg-gray-300 text-center shadow-xl">
            ...
            <!-- <p class="font-bold mb-4"> We have reserved your spot.</p> -->
    ...
    <script>
        ...
        const setZip = () => {
            ...
            newUrl.searchParams.set('ip_zip', "<?php echo htmlspecialchars($ipZip); ?>");
            window.history.pushState({
                path: newUrl.href
            }, '', newUrl.href);
        };
        ...
        const btnUnder64 = document.getElementById("btn-under-64");
        btnUnder64.addEventListener("click", () => {
            window.location.href = "not-qualify.php";
        });
